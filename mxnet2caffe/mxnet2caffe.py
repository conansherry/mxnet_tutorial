...
parser.add_argument('--mx-model',    type=str, default='resnet-fast8-2class')
parser.add_argument('--mx-epoch',    type=int, default=8)
parser.add_argument('--cf-prototxt', type=str, default='person_seg_v12_train.prototxt')
parser.add_argument('--cf-model',    type=str, default='person_seg_v12_train.caffemodel')
...
for i_key,key_i in enumerate(all_keys):
  ...
  try:    
    if 'data' == key_i or 'softmax_label' == key_i:
      pass
