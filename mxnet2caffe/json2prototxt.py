...
parser.add_argument('--mx-json',     type=str, default='resnet-fast8-2class-symbol.json')
parser.add_argument('--cf-prototxt', type=str, default='person_seg_v12_deploy.prototxt')
